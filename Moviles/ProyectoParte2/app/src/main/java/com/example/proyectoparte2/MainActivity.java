...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClick(View v) {
        ...
        if (dbHelper.userExists(username, password)) {
            ...
            Toast.makeText(MainActivity.this, "Preparate para relajarte", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(MainActivity.this, "Pruebe de nuevo", Toast.LENGTH_SHORT).show();
        }
    }
});
    }
