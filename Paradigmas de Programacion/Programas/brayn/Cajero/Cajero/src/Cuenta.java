            ...
            while(x==1){
                try{
                    ...
                    if(Retirar==null){
                        ...
                        double retirarDoub=Double.parseDouble(Retirar);
                        if(retirarDoub>0){
                            if(saldo<1000){
                                if(saldo>=retirarDoub+comision){
                                    saldo=saldo-(retirarDoub+comision);
                                    JOptionPane.showMessageDialog(null, "Se ha retirado la cantidad de: "+"$"+retirarDoub+" mas la comision");
                                    x=0;
                                }else{
                                ...
                                if(saldo>=retirarDoub){
                                    JOptionPane.showMessageDialog(null, "Se ha retirado la cantidad de: "+"$"+retirarDoub);
                                    saldo=saldo-retirarDoub;
                                    x=0;
                                }else{
                                    JOptionPane.showMessageDialog(null, "Saldo Insuficiente");
                                    x=0;
